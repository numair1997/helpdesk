        ...
        <>
            <div className="w-full">
                <button className="mt-6 flex w-full items-center justify-center gap-2 rounded-2xl border border-n30 py-3">
                    ...
                    <span className="text-sm font-medium text-[#555555]">Sign Up with Microsoft</span>
                </button>
                ...
                <button className="mt-3 flex w-full items-center justify-center gap-2 rounded-2xl border border-n30 py-3">
                    ...
                    <span className="text-sm font-medium text-[#555555]">Sign Up with Google</span>
                </button>
            ...
            <button className="mt-6 flex w-full items-center justify-center gap-2 rounded-2xl border border-black py-3">
                <span className="text-sm font-medium text-black">Sign Up With Email</span>
            </button>
        </>
    )
}
